  ...
  return (
    <div className="mx-auto max-w-2xl p-8">
      ...
      <p className="mt-1 text-sm text-text-secondary">
        Add your own API keys for each provider you want to use. Keys are
        stored privately on your account and sent only to that provider when
        you chat.
      </p>
          ...
          <div key={field.key}>
            ...
            <input
              ...
              onChange={(e) => {
                ...
                setApiKeys((prev) => ({ ...prev, [field.key]: value }));
              }}
